                ...
                <div className="flex flex-col">
                    ...
                    <main className="flex items-center justify-center flex-1 overflow-auto p-4">
                        <div className="relative flex h-full w-full max-w-4xl min-h-[50vh] flex-col rounded-xl bg-inherit p-4 border-2 border-sky-500 shadow-xl">
                            ...
                            */}
                            <form
                                className="relative overflow-hidden rounded-lg border-2 border-white bg-inherit focus-within:border-2 focus-within:border-sky-500" x-chunk="dashboard-03-chunk-1"
                            >
                                ...
                                <div className="flex items-center p-3 pt-0">
                                    ...
                                    <Button type="submit" onClick={sendMessage} size="sm" variant="ghost" className="ml-auto gap-1.5 text-white font-bold shadow-none border-2 rounded-full bg-sky-900/15 border-sky-500 hover:shadow-none">
                                        Send Message
